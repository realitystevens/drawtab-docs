...
| `billing` | `object` | `{ creditsRemaining, rendersRemaining, creditsCost, watermarked, isFreeTier }` — see [Billing & Credits](/billing-and-credits) |
...
| `X-Drawtab-Watermark` | `true`/`false` — see [Billing & Credits](/billing-and-credits) |
